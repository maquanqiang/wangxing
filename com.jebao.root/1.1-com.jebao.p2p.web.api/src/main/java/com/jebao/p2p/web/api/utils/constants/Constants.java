...
public class Constants {
    ...
    public static CachedSetting CACHED_API_PRODUCT_PRODUCTDETAIL = new CachedSetting(DOMAIN+"api_product_productDetail",60*60*24,10,5,"标的详情页缓存24小时(url=/api/product/productDetail/*)");
