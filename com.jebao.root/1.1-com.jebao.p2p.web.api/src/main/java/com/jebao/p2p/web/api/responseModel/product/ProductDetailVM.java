...
public class ProductDetailVM extends ViewModel {
    ...
    public ProductDetailVM(TbBidPlan entity){
        ...
        this.bpStatus = (entity.getBpStatus() == 2 && entity.getBpEndTime().before(new Date()))?4:entity.getBpStatus();
        ...
        this.bpLoginId = entity.getBpLoginId();
