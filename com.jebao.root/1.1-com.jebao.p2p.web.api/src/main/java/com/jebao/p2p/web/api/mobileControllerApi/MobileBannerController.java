...
public class MobileBannerController {
    ...
    public JsonResult bannerList(){
        ...
        bannerList.add(new MobileBannerVm(1, path+"html/phone/images/banner01.png", path+"html/phone/security.html"));
        bannerList.add(new MobileBannerVm(2, path+"html/phone/images/banner02.png", path+"html/phone/rose.html"));
        bannerList.add(new MobileBannerVm(3, path+"html/phone/images/banner03.png", path+"html/phone/NewWebsite.html"));
